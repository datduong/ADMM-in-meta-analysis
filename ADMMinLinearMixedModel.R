...
sigma2 = 2 # square root version
sigma3 = 3 # square root version 
sigma4 = 4 # square root version
...
for ( random_init in 1:1 ) {
	...
	gamma2_guess = runif(1,1,2) ## guess the squared valued 
	gamma3_guess = runif(1,1,2) ## guess the squared valued 
	gamma4_guess = runif(1,1,2) ## guess the squared valued 
	sigma = runif(1,1,2) ## guess the squared valued 
	R = I ## init values
	Y = I ## init values
